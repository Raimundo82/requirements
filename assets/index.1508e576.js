...
`,J="identifica\xE7\xE3o",G="requerimento",K="submiss\xE3o",N={identification:J,requirement:G,submission:K};window.html=String.raw;const C=u("#app-state"),W=()=>C.querySelector("[active]").toggleAttribute("active"),Y=({detail:{state:e}})=>{R({state:e}),W(),C.querySelectorAll("button.btn-state")[e].toggleAttribute("active")},Z=()=>html`
  ...
  `);return e.querySelector("#formButtons").appendChild(de()),e}const b=u("#app");b.addEventListener("pointerover",he);function he(){$(()=>import("./popper.9ecf204a.js"),[]),$(()=>import("./bootstrap.esm.min.9853106f.js"),[]),$(()=>import("./pdfGen.fc0e7559.js").then(e=>e.d),[])}async function ge(e){const{requirement:n}=await $(()=>import("./requirements.d5c54198.js"),["assets/requirements.d5c54198.js","assets/bootstrap.esm.min.9853106f.js"]);n({requirementName:e})}async function ye(){const e=(await $(()=>import("./submission.99c14b36.js"),["assets/submission.99c14b36.js","assets/pdfGen.fc0e7559.js"])).default;e()}function L(){b.innerHTML=""}function qe(){L(),q(b,"change-state",{state:0}),B()}function Se(){const e=f().identificationData.selectedRequirement;L(),q(b,"change-state",{state:1}),R({currentState:1}),ge(e)}function Ee(){L(),q(b,"change-state",{state:2}),ye()}b.addEventListener("identification-step",qe);b.addEventListener("requirement-step",Se);b.addEventListener("submission-step",Ee);B();export{de as F,$ as _,f as a,$e as b,x as c,q as d,u as g,me as p,R as s};
