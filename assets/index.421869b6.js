...
`,B="identifica\xE7\xE3o",J="requerimento",G="submiss\xE3o",N={identification:B,requirement:J,submission:G},K="/requirements/assets/prev.fcdf48d8.svg";window.html=String.raw;const D=s("#app-state"),W=()=>D.querySelector("[active]").toggleAttribute("active"),Y=e=>{switch(e){case 0:return s("#btn-prev").toggleAttribute("disabled",!0);case 1:return s("#btn-prev").toggleAttribute("disabled",!1);case 2:return s("#btn-prev").toggleAttribute("disabled",!1)}},Z=({detail:{state:e}})=>{_({state:e}),W(),D.querySelectorAll("button.btn-state")[e].toggleAttribute("active"),Y(e)},Q=()=>{if(b().state===1)return y(s("#app"),"identification-step");if(b().state===2)return y(s("#app"),"requirement-step")},V=()=>html`
  ...
  `}const v=s("#app");v.addEventListener("pointerover",fe);function fe(){$(()=>import("./popper.9ecf204a.js"),[]),$(()=>import("./bootstrap.esm.min.9853106f.js"),[]),$(()=>import("./pdfGen.fc0e7559.js").then(e=>e.d),[])}async function be(e){const{requirement:n}=await $(()=>import("./requirements.697e906f.js"),["assets/requirements.697e906f.js","assets/bootstrap.esm.min.9853106f.js"]);n({requirementName:e})}async function ve(){const e=(await $(()=>import("./submission.2e89fea1.js"),["assets/submission.2e89fea1.js","assets/pdfGen.fc0e7559.js"])).default;e()}function L(){v.innerHTML=""}function he(){L(),y(v,"change-state",{state:0}),F()}function ge(){const e=b().identificationData.selectedRequirement;L(),y(v,"change-state",{state:1}),_({currentState:1}),be(e)}function ye(){L(),y(v,"change-state",{state:2}),ve()}v.addEventListener("identification-step",he);v.addEventListener("requirement-step",ge);v.addEventListener("submission-step",ye);F();export{$ as _,b as a,qe as b,P as c,y as d,s as g,_ as s};
