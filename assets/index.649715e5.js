...
`,B="identifica\xE7\xE3o",J="requerimento",G="submiss\xE3o",w={identification:B,requirement:J,submission:G},K="/requirements/assets/prev.fcdf48d8.svg";window.html=String.raw;const N=s("#app-state"),W=()=>N.querySelector("[active]").toggleAttribute("active"),Y=e=>{switch(e){case 0:return s("#btn-prev").toggleAttribute("disabled",!0);case 1:return s("#btn-prev").toggleAttribute("disabled",!1);case 2:return s("#btn-prev").toggleAttribute("disabled",!1)}},Z=({detail:{state:e}})=>{R({state:e}),W(),N.querySelectorAll("button.btn-state")[e].toggleAttribute("active"),Y(e)},Q=()=>{if(b().state===1)return y(s("#app"),"identification-step");if(b().state===2)return y(s("#app"),"requirement-step")},X=()=>html`
  ...
  `}const v=s("#app");async function be(e){const t=(await te(Object.assign({"./components/requirements/licencaParental/licencaParental.js":()=>$(()=>import("./licencaParental.c9bd11bd.js"),["assets/licencaParental.c9bd11bd.js","assets/licencaParentalTemplate.699c0592.js"]),"./components/requirements/licencaParental/licencaParentalTemplate.js":()=>$(()=>import("./licencaParentalTemplate.699c0592.js"),[]),"./components/requirements/licencaSemRemuneracap/licencaSemRemuneracao.js":()=>$(()=>import("./licencaSemRemuneracao.f5fd7b8c.js"),[])}),`./components/requirements/${e}/${e}.js`)).default;t()}async function ve(){const e=(await $(()=>import("./submission.4abcc530.js"),[])).default;e()}function D(){v.innerHTML=""}function ge(){D(),y(v,"change-state",{state:0}),F()}function he(){const e=b().identificationData.selectedRequirement;D(),y(v,"change-state",{state:1}),R({currentState:1}),be(e)}function ye(){D(),y(v,"change-state",{state:2}),ve(b())}v.addEventListener("identification-step",ge);v.addEventListener("requirement-step",he);v.addEventListener("submission-step",ye);F();export{b as a,qe as b,O as c,s as g,R as s};
