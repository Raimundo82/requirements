...
`,B="identifica\xE7\xE3o",J="requerimento",G="submiss\xE3o",N={identification:B,requirement:J,submission:G},K="/requirements/assets/prev.fcdf48d8.svg";window.html=String.raw;const L=s("#app-state"),V=()=>L.querySelector("[active]").toggleAttribute("active"),W=e=>{switch(e){case 0:return s("#btn-prev").toggleAttribute("disabled",!0);case 1:return s("#btn-prev").toggleAttribute("disabled",!1);case 2:return s("#btn-prev").toggleAttribute("disabled",!1)}},Y=({detail:{state:e}})=>{x({state:e}),V(),L.querySelectorAll("button.btn-state")[e].toggleAttribute("active"),W(e)},Z=()=>{if(b().state===1)return q(s("#app"),"identification-step");if(b().state===2)return q(s("#app"),"requirement-step")},Q=()=>html`
  ...
  `}const v=s("#app");v.addEventListener("pointerover",fe);function fe(){y(()=>import("./createPopper.bcd46c80.js"),[]),y(()=>import("./bootstrap.esm.min.9853106f.js"),[]),y(()=>import("./pdfGen.ed233da8.js"),[]),y(()=>Promise.resolve({}),["assets/bootstrap.min.d10a694a.css"])}async function be(e){const{requirement:n}=await y(()=>import("./requirements.e3fbceb2.js"),["assets/requirements.e3fbceb2.js","assets/requirements.d10a694a.css","assets/bootstrap.esm.min.9853106f.js"]);n({requirementName:e})}async function ve(){const e=(await y(()=>import("./submission.e6391057.js"),["assets/submission.e6391057.js","assets/pdfGen.ed233da8.js"])).default;e()}function D(){v.innerHTML=""}function he(){D(),q(v,"change-state",{state:0}),F()}function ge(){const e=b().identificationData.selectedRequirement;D(),q(v,"change-state",{state:1}),x({currentState:1}),be(e)}function ye(){D(),q(v,"change-state",{state:2}),ve()}v.addEventListener("identification-step",he);v.addEventListener("requirement-step",ge);v.addEventListener("submission-step",ye);F();export{y as _,b as a,qe as b,P as c,q as d,s as g,x as s};
